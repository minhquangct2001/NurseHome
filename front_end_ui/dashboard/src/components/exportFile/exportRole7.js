...
const ExportFileRole7 = async () => {
  try {
    const response = await axios.get("http://localhost:8080/api/exportToExcel/role7", {
    ...
    link.href = url;
    link.setAttribute("download", "Parmacsic.xlsx");
...
export default ExportFileRole7;
