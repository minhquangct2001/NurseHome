...
const ExportFileMenu = async () => {
  try {
    const response = await axios.get("http://localhost:8080/api/exportToExcel/menu", {
    ...
    link.href = url;
    link.setAttribute("download", "menu.xlsx");
