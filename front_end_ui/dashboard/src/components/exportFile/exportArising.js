...
const ExportFileServiceArising = async () => {
  try {
    const response = await axios.get("http://localhost:8080/api/exportToExcel/arising", {
    ...
    link.href = url;
    link.setAttribute("download", "Arising.xlsx");
...
export default ExportFileServiceArising;
