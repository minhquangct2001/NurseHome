...
const ExportFileRole4 = async () => {
  try {
    const response = await axios.get("http://localhost:8080/api/exportToExcel/role4", {
    ...
    link.href = url;
    link.setAttribute("download", "Nurse.xlsx");
...
export default ExportFileRole4;
