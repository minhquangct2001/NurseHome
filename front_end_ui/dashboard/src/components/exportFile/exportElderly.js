...
const ExportFileElderly = async () => {
  try {
    const response = await axios.get("http://localhost:8080/api/exportToExcel/elderly", {
    ...
    link.href = url;
    link.setAttribute("download", "Elderly.xlsx");
...
export default ExportFileElderly;
