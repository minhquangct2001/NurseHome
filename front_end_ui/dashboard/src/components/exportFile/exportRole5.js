...
const ExportFileRole5 = async () => {
  try {
    const response = await axios.get("http://localhost:8080/api/exportToExcel/role5", {
    ...
    link.href = url;
    link.setAttribute("download", "HR.xlsx");
...
export default ExportFileRole5;
