...
public class ActivityHistoryController {
    ...
    public String getAllActivity()  {
        return activityHistoryImp.findAllActivity();
    }

    @GetMapping("/{activityId}")
    public String getById(@PathVariable long activityId ){
        return String.valueOf(activityHistoryImp.findActivityId(activityId));
    }
    @PostMapping()
    public String creatActivity(@RequestBody String jsonString) throws JsonProcessingException {
        return activityHistoryImp.createActivity(jsonString);
    }
